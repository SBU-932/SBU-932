...
import objects.elements.Gun3;

public class Engine3 extends Engine implements Runnable {
	...
	private void loadGameObjects() {
		Assets.turn = new boolean[2];
		Assets.turn[0] = true;
		Assets.turn[1] = false;
		
		Assets.scores = new int[2];
		
		BlockManager2 bm = new BlockManager2();
		gameObjects.add(bm);
		Gun3 gun = new Gun3(0,20, 570, 30, 50, Color.GRAY, Color.BLUE);
		gameObjects.add(gun);
		
		Gun3 gun2 = new Gun3(1,620, 570, 30, 50, Color.GRAY, Color.BLUE);
		gameObjects.add(gun2);
